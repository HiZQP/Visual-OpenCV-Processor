...
namespace VCVP {
    ...
    DataFlowGraphicsScene::DataFlowGraphicsScene(QtNodes::DataFlowGraphModel& graphModel, QObject* parent)
    ...
    std::vector<QtNodes::NodeId> DataFlowGraphicsScene::selectedNodes() const
    {
